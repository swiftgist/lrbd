...
class BackstoresTestCase(unittest.TestCase):
    ...
    def test_iblock(self):
        ...
        assert self.b.cmds == [['targetcli', '/backstores/iblock', 'create', 'name=rbd-archive', 'dev=/dev/rbd/rbd/archive']]
    ...
    def test_rbd(self):
        ...
        self.b = mock_Backstores("rbd")
        assert self.b.cmds == [['targetcli', '/backstores/rbd', 'create', 'name=rbd-archive', 'dev=/dev/rbd/rbd/archive']]
